...
4. Treat if-statements like paragraphs, where each if-elsif-else 
...
5. Your boolean tests should be simple. If they are complex, 
   move their calculations to variables earlier in your function and
...
2. The best way to debug a program is to use put to print out the
